...
const About = () => {
  return (
    <>
      <section
        id="about"
        className="py-20 bg-gradient-to-b from-softBeige to-marbleWhite dark:from-charcoalBlack dark:to-slateGray/10
      "
      >
        <div className="container mx-auto px-6 md:px-12 lg:px-16 flex flex-col md:flex-row items-center gap-10">
          {/* Left Side: Text Content */}
          <div className="md:w-1/2 text-center md:text-left">
            <h2 className="text-4xl font-bold text-charcoalBlack dark:text-champagneGold">
              Crafting Luxury Since 2000
            </h2>
            <p className="mt-4 text-lg text-slateGray dark:text-softBeige leading-relaxed">
            ...
            <button className="mt-6 bg-emeraldGreen text-softBeige px-6 py-3 rounded-md hover:bg-champagneGold hover:text-charcoalBlack transition">
      ...
      <section className="py-20 bg-gradient-to-b dark:to-charcoalBlack dark:from-slateGray/10 from-marbleWhite to-softBeige dark:bg-charcoalBlack">
        <div className="container mx-auto px-6 md:px-12 lg:px-16 flex flex-col md:flex-row items-center gap-10">
